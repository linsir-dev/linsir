...
import com.linsir.core.cloud.feign.LinsirFeignAutoConfiguration;
 ...
 */
@NoArgsConstructor
public class LinsirFeignClientsRegistrar implements ImportBeanDefinitionRegistrar, BeanClassLoaderAware, EnvironmentAware {
	@Getter
	...
	private Class<?> getSpringFactoriesLoaderFactoryClass() {
		return LinsirFeignAutoConfiguration.class;
	}
