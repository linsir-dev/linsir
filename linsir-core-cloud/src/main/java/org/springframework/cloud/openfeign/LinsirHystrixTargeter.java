...
import com.linsir.core.cloud.feign.LinsirFallbackFactory;
import feign.Feign;
import feign.Target;
...
public class LinsirHystrixTargeter  {
	...
	public <T> T target(FeignClientFactoryBean factory, Feign.Builder feign, FeignContext context,
		...
		LinsirFallbackFactory bladeFallbackFactory = new LinsirFallbackFactory(target);
