...
public class D extends DateUtils {
    ...
    public static final String FORMAT_DATE_M2 = "MM";

    public static final String FORMAT_DATE_y4M2 = "yyyy-MM";
    ...
    public static String getYear(){
        ...
        SimpleDateFormat sdf = new SimpleDateFormat(FORMAT_DATE_y4);
        return  sdf.format(calendar.getTime());
    }

    /**
     * 得到 当前年，用于生成文件夹  yyyy-MM
     * @return
     */
    public static String getYearMonth4(){
        Calendar calendar = Calendar.getInstance();
        SimpleDateFormat sdf = new SimpleDateFormat(FORMAT_DATE_y4M2);
        return  sdf.format(calendar.getTime());
    }
