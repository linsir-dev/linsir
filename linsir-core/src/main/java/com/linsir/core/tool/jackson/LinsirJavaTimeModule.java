...
import com.linsir.core.tool.utils.DateTimeUtil;
 ...
 * @author L.cm
 */
public class LinsirJavaTimeModule extends SimpleModule {
	public static final LinsirJavaTimeModule INSTANCE = new LinsirJavaTimeModule();

	public LinsirJavaTimeModule() {
